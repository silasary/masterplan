...
namespace Masterplan.UI
{
	internal class HandoutForm : Form
	{
		...
		{
			ComponentResourceManager resources = new ComponentResourceManager(typeof(HandoutForm));
			...
			this.DMInfoBtn.Image = (Image)resources.GetObject("DMInfoBtn.Image");
			...
			this.AddAllBtn.Image = (Image)resources.GetObject("AddAllBtn.Image");
