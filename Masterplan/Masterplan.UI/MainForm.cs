	...
	internal partial class MainForm : Form
	{
		...
		public MainForm()
		{
			...
			try
			{
				...
				foreach (IAddIn addin in this.fExtensibility.AddIns)
				{
					...
					foreach (IPage refpage in addin.QuickReferencePages)
					{
						TabPage tabPage2 = new TabPage();
						tabPage2.Text = refpage.Name;
						tabPage2.Controls.Add(refpage.Control);
						refpage.Control.Dock = DockStyle.Fill;
		...
		public void UpdateView()
		{
			try
			{
				...
				else if (fView == ViewType.Map)
				{
					foreach (Control control in PreviewSplitter.Panel1.Controls)
					{
						if (control is RegionalMapPanel)
						{
							RegionalMapPanel regionalMapPanel = control as RegionalMapPanel;
