	...
	internal class TerrainPowerSelectForm : Form
	{
		...
		public TerrainPower TerrainPower
		{
			get
			{
				...
				{
					return this.ChallengeList.SelectedItems[0].Tag as TerrainPower;
				}
				return null;
			}
		}
		...
		public TerrainPowerSelectForm()
		{
			...
			List<TerrainPower> terrainPowers = Session.TerrainPowers;
			foreach (TerrainPower current in terrainPowers)
			{
		...
		{
			string text = HTML.TerrainPower(this.TerrainPower, DisplaySize.Small);
