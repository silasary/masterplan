...
namespace Masterplan.UI
{
	internal class MainForm : Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.FileNew.ShortcutKeys = (Keys)131150;
			...
			this.FileOpen.ShortcutKeys = (Keys)131151;
			...
			this.FileSave.ShortcutKeys = (Keys)131155;
			...
			this.ProjectProject.ShortcutKeys = (Keys)131152;
			...
			this.ToolsLibraries.ShortcutKeys = (Keys)131148;
