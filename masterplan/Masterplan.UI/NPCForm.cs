...
namespace Masterplan.UI
{
	internal class NPCForm : Form
	{
		...
		public NPCForm(NPC cc, bool unused)
		{
			...
			CreatureTemplate creatureTemplate = Session.FindTemplate(this.fNPC.TemplateID, SearchType.Global);
		...
		private void Application_Idle(object sender, EventArgs e)
		{
			...
			this.PowerUpBtn.Enabled = (this.SelectedPower != null && this.fNPC.CreaturePowers.IndexOf(this.SelectedPower) != 0);
			this.PowerDownBtn.Enabled = (this.SelectedPower != null && this.fNPC.CreaturePowers.IndexOf(this.SelectedPower) != this.fNPC.CreaturePowers.Count - 1);
		...
		private void TemplateBox_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			this.fNPC.TemplateID = ((creatureTemplate != null) ? creatureTemplate.ID : Guid.Empty);
			this.update_fields();
		}
		...
		private void PowerEditBtn_Click(object sender, EventArgs e)
		{
			if (this.SelectedPower != null)
			{
				int index = this.fNPC.CreaturePowers.IndexOf(this.SelectedPower);
				PowerBuilderForm powerBuilderForm = new PowerBuilderForm(this.SelectedPower, this.fNPC, false);
				if (powerBuilderForm.ShowDialog() == DialogResult.OK)
				{
					this.fNPC.CreaturePowers[index] = powerBuilderForm.Power;
					this.update_powers_list();
				}
			}
		}
		...
		private void update_powers_list()
		{
			...
			foreach (CreaturePower current in this.fNPC.CreaturePowers)
			{
		...
		private void EditDmgBtn_Click(object sender, EventArgs e)
		{
			if (this.SelectedDamageMod != null)
			{
				int index = this.fNPC.DamageModifiers.IndexOf(this.SelectedDamageMod);
				DamageModifierForm damageModifierForm = new DamageModifierForm(this.SelectedDamageMod);
				if (damageModifierForm.ShowDialog() == DialogResult.OK)
				{
					this.fNPC.DamageModifiers[index] = damageModifierForm.Modifier;
					this.update_damage_list();
				}
			}
		}
		...
		private void update_damage_list()
		{
			...
			foreach (DamageModifier current in this.fNPC.DamageModifiers)
			{
		...
		private void AuraEditBtn_Click(object sender, EventArgs e)
		{
			if (this.SelectedAura != null)
			{
				int index = this.fNPC.Auras.IndexOf(this.SelectedAura);
				AuraForm auraForm = new AuraForm(this.SelectedAura);
				if (auraForm.ShowDialog() == DialogResult.OK)
				{
					this.fNPC.Auras[index] = auraForm.Aura;
					this.update_aura_list();
				}
			}
		}
		...
		private void update_aura_list()
		{
			...
			foreach (Aura current in this.fNPC.Auras)
			{
		...
		private void DetailsEditBtn_Click(object sender, EventArgs e)
		{
			...
			{
				DetailsForm detailsForm = new DetailsForm(this.fNPC, this.SelectedField, null);
		...
		{
			int num = this.fNPC.CreaturePowers.IndexOf(this.SelectedPower);
			CreaturePower value = this.fNPC.CreaturePowers[num - 1];
			this.fNPC.CreaturePowers[num - 1] = this.SelectedPower;
			this.fNPC.CreaturePowers[num] = value;
			this.update_powers_list();
		...
		{
			Regeneration regeneration = this.fNPC.Regeneration;
		...
		private void InitializeComponent()
		{
			...
			this.NameBox.Size = new Size(325, 20);
			...
			NumericUpDown arg_7A8_0 = this.LevelBox;
			int[] array = new int[4];
			array[0] = 40;
			arg_7A8_0.Maximum = new decimal(array);
			NumericUpDown arg_7C7_0 = this.LevelBox;
			int[] array2 = new int[4];
			array2[0] = 1;
			arg_7C7_0.Minimum = new decimal(array2);
			this.LevelBox.Name = "LevelBox";
			this.LevelBox.Size = new Size(325, 20);
			this.LevelBox.TabIndex = 3;
			NumericUpDown arg_819_0 = this.LevelBox;
			int[] array3 = new int[4];
			array3[0] = 1;
			arg_819_0.Value = new decimal(array3);
			...
			NumericUpDown arg_D8C_0 = this.InitModBox;
			int[] array4 = new int[4];
			array4[0] = 1000;
			arg_D8C_0.Maximum = new decimal(array4);
			...
			NumericUpDown arg_F4B_0 = this.HPModBox;
			int[] array5 = new int[4];
			array5[0] = 1000;
			arg_F4B_0.Maximum = new decimal(array5);
			...
			NumericUpDown arg_10E0_0 = this.ACModBox;
			int[] array6 = new int[4];
			array6[0] = 1000;
			arg_10E0_0.Maximum = new decimal(array6);
			...
			NumericUpDown arg_1277_0 = this.FortModBox;
			int[] array7 = new int[4];
			array7[0] = 1000;
			arg_1277_0.Maximum = new decimal(array7);
			...
			NumericUpDown arg_140E_0 = this.RefModBox;
			int[] array8 = new int[4];
			array8[0] = 1000;
			arg_140E_0.Maximum = new decimal(array8);
			...
			NumericUpDown arg_15AB_0 = this.WillModBox;
			int[] array9 = new int[4];
			array9[0] = 1000;
			arg_15AB_0.Maximum = new decimal(array9);
			...
			this.Pages.Size = new Size(385, 219);
			...
			this.AbilitiesPage.Size = new Size(377, 193);
			...
			this.CostBox.Size = new Size(294, 20);
			...
			this.CostLbl.Size = new Size(31, 13);
			...
			this.CombatPage.Size = new Size(377, 193);
			...
			this.PowersPage.Size = new Size(377, 193);
			...
			this.PowerList.Size = new Size(371, 162);
			...
			this.AuraPage.Size = new Size(377, 193);
			...
			this.AuraList.Size = new Size(371, 162);
			...
			this.DamagePage.Size = new Size(377, 193);
			...
			this.DamageList.Size = new Size(371, 162);
			...
			this.DetailsPage.Size = new Size(377, 193);
			...
			this.DetailsList.Size = new Size(371, 162);
			...
			this.PicturePage.Size = new Size(377, 193);
			...
			this.PortraitBox.Size = new Size(371, 162);
			...
			this.TemplateBox.Size = new Size(325, 21);
			...
			this.InfoBtn.Size = new Size(325, 23);
			...
			base.ClientSize = new Size(409, 380);
