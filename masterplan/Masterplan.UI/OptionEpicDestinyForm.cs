...
namespace Masterplan.UI
{
	...
	{
		private EpicDestiny fEpicDestiny;
		...
		private void update_levels()
		{
			...
			foreach (LevelData current in this.fEpicDestiny.Levels)
			{
		...
		{
			ComponentResourceManager resources = new ComponentResourceManager(typeof(OptionEpicDestinyForm));
			...
			this.ImmortalityPage.Padding = new Padding(3);
			this.ImmortalityPage.Size = new Size(341, 239);
			...
			this.ImmortalityBox.Size = new Size(335, 233);
